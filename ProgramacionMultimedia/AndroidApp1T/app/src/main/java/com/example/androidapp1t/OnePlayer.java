...
public class OnePlayer extends Activity implements View.OnClickListener {
    ...
    int draws=0;
    int random=0;
    private static int me=0, pc=0, tie=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goBack=findViewById(R.id.goBackOnePlayer);
        for (int i=0;i<=8;i++){
            matrix[i]=0;
        }
    ...
    public void updateScores(){
        ...
        scorePcWin.setText(String.valueOf(pc));
    ...
    public void check(){
        if (win){
            Toast toast=Toast.makeText(this,"¡Has ganado!",Toast.LENGTH_LONG);
            toast.show();
            me++;
            restart(this);
        }
        if (pcWin){
            Toast toast=Toast.makeText(this,"¡Has perdido!",Toast.LENGTH_LONG);
            toast.show();
            pc++;
            restart(this);
        }
