...
export default function DoPractice() {
    ...
    const {id, id2}=useParams()
        ...
        const onSubmit= async(e)=>{
            e.preventDefault();
            await axios.post(`http://localhost:8886/api/alumnos/${id}/hacerPractica/${id2}`,practice)
        ...
        <div className='row'>
            <div className='col-md-6 offset-md-3 border rounded p-4 mt-2 shadow'>
                ...
                <div className='mb-3'>
                    ...
                    <input type={"text"} className="form-control"  placeholder='2023-02-25' name="fecha" value={fecha} onChange={(e)=>onInputChange(e)}/>
                </div>
                <div className='mb-3'>
